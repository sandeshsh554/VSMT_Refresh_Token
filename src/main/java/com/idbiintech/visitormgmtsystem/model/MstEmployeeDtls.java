...
public class MstEmployeeDtls {
	...
	public String toString() {
		return "MstEmployeeDtls [id=" + id + ", empname=" + empname + ", department=" + department + ", designation="
				...
				+ ", versionName=" + versionName + ", emppass=" + emppass + ", jwttoken=" + jwttoken + ", empcnt="
				+ empcnt + ", emailid=" + emailid + "]";
	}
